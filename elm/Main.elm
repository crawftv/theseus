...
fetchBookPageCmd title chapter =
    RemoteData.Http.getWithConfig RemoteData.Http.defaultConfig (crossOrigin "https://theseus-api.crawfordc.com/books" [ title, String.fromInt chapter ] []) UseBookPageResponseToRenderPage bookPageDecoder


fetchBookPageCommentaryCmd : Title -> Chapter -> LineNumber -> Cmd Msg
fetchBookPageCommentaryCmd title chapter lineNumber =
    RemoteData.Http.getWithConfig RemoteData.Http.defaultConfig (crossOrigin "https://theseus-api.crawfordc.com/books" [ title, String.fromInt chapter, String.fromInt lineNumber ] []) UseBookPageCommentaryResponseToRenderPage bookPageCommentaryDecoder
